...
public class Utilisateur {
    ...
    public Utilisateur(int id, String nom, String prenom, String addresse, String email, String username, String password, String role, String sexe, int numero, String avatar, String code, String confirmed) {
        this.id = id;
        this.nom = nom;
        this.prenom = prenom;
...
//    String etat;
    ...
    public Utilisateur(String nom, String prenom, String addresse, String email, String username, String password, String sexe, int numero, String avatar) {
        this.nom = nom;
        this.prenom = prenom;
        this.addresse = addresse;
        this.email = email;
    ...
    public Utilisateur(int id, String nom, String prenom, String addresse, String email, String username, String password, String role, int numero, String avatar, String sexe) {
        this.id = id;
        this.nom = nom;
        this.prenom = prenom;
        this.addresse = addresse;
    ...
    public Utilisateur(String nom, String prenom, String addresse, String email, String sexe, int numero, String avatar,String password,String username) {
        this.nom = nom;
        this.prenom = prenom;
        this.addresse = addresse;
        this.email = email;
