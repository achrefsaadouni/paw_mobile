...
public class AfficheVeterinaire {
    ...
    public AfficheVeterinaire(Resources theme) {
        this.theme = theme;
        f = new Form();
        lb = new SpanLabel("");
        f.add(lb);
        ...
        f.getToolbar().addCommandToRightBar("back", null, (ev) -> {
            VeterinaireForm h = new VeterinaireForm(theme);
            h.getF().show();
    ...
    public Container addItem(Veterinaire v,RateVet sonRate ) {
        ...
        i.setImage(URLImage.createToStorage(placeholder, v.getImages(), "http://localhost/paw_web/web/images/pawVets/" + v.getImages()));
...
//            p.getF().show();
            ...
            hi.getToolbar().addCommandToRightBar("back", null, (ev)
                    -> {
                AfficheVeterinaire h = new AfficheVeterinaire(theme);
