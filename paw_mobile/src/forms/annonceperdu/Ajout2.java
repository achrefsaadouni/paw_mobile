...
import forms.annonceperdu.Affichage2;
...
public class Ajout2 {
   ...
   private  String fileNameInServer ="";
    public Ajout2(Resources theme) {
        this.theme = theme;
        f = new Form("Ajout Annonce Perdu");
        colier = new TextField("","Porte t'il un Colier",30,TextArea.ANY);
        lieu_perdu = new TextField("","Lieu Perdu",30,TextArea.ANY);
       ...
       c1.add(combo1);
        ...
        choisirImage.addActionListener(new ActionListener() {
            ...
            System.out.println(combo.getModel().getSelectedIndex());
               if(Integer.parseInt(age.getText())>0 && !colier.getText().equals("") && !lieu_perdu.getText().equals("") && !couleur.getText().equals("")&& !race.getText().equals("") && !message.getText().equals(""))
                {
            AnnoncePerdu t = new AnnoncePerdu(colier.getText(),lieu_perdu.getText(),0,Integer.valueOf(age.getText()),couleur.getText(),sexe,race.getText(),message.getText(),animal,fileNameInServer,Utilisateur.membre.getId());
            System.out.println(t.getImages());
            System.out.println(fileNameInServer);
            ser.ajoutAnnoncePerdu(t);
        ...
        f.getToolbar().addCommandToOverflowMenu("Affichers Toutes Les Annonces", null, (e)
                -> {
        Affichage2 a=new Affichage2(theme);
        a.getF().show();
        }
        );
         ...
         Container cc7 = new Container(new BoxLayout(BoxLayout.X_AXIS)) ;
            Label lieu69= new Label ("Lieux Perdu  :") ; 
            ...
            TextField  lieuxkl = new TextField(ed.getLieu_perdu()) ; 
            ...
            TextField colier12 = new TextField(ed.getColier()) ;
             lieuxkl.setText(ed.getLieu_perdu());
            ...
            confirm.addActionListener(ty->{
              ...
              ServiceAnnoncePerdu ann = new ServiceAnnoncePerdu() ; 
     ...
     public Container afficherMesAnnonces(AnnoncePerdu at)
            {
